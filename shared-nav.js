...
(function () {
    ...
    var SECTIONS = {
        rb: {
            ...
            short: 'РБ',
            items: [
                { href: 'rb-svod.html', title: 'Свод расходов 2026-2028', key: 'rb_svod' },
                { href: 'rb-svodnaya.html', title: 'Сводная общая 2026', key: 'rb_svodnaya' },
                { href: 'rb-income.html', title: 'Доходы РБ', key: 'rb_income' },
                { href: 'rb-fzp.html', title: 'Фонд заработной платы', key: 'rb_fzp' },
                { href: 'fot-almaty.html', title: 'Свод ФОТ Алматы', key: 'fot' },
                { href: 'rb-kalkulyacia.html', title: 'Калькуляция расходов', key: 'rb_kalkulyacia' },
                { href: 'rb-plan-komandir.html', title: 'План командировок РК', key: 'rb_plan_komandir' }
            ]
        },
        pu: {
            ...
            short: 'ПУ',
            items: [
                { href: 'pu-svod-2026.html', title: 'Свод ПУ 2026', key: 'pu_svod_2026' },
                { href: 'pu-ss-dotacia.html', title: 'СС Дотация', key: 'pu_ss_dotacia' },
                { href: 'pu-ss-almaty.html', title: 'СС Алматы', key: 'pu_ss_almaty' },
                { href: 'pu-income-pu.html', title: 'Доходы ПУ', key: 'pu_income_pu' },
                { href: 'pu-income-dt.html', title: 'Доходы ДТ', key: 'pu_income_dt' },
                { href: 'pu-income-dop.html', title: 'Доходы ДОП', key: 'pu_income_dop' },
                { href: 'pu-fot-almaty.html', title: 'ФОТ Алматы', key: 'pu_fot_almaty' },
                { href: 'pu-grafik-almaty.html', title: 'График Алматы', key: 'pu_grafik_almaty' },
                { href: 'pu-kalkulyacia-almaty.html', title: 'Калькуляция Алматы', key: 'pu_kalkulyacia_almaty' },
                { href: 'pu-plan-rk.html', title: 'План командировок РК', key: 'pu_plan_rk' },
                { href: 'pu-plan-abroad.html', title: 'План командировок за рубеж', key: 'pu_plan_abroad' }
            ]
        },
        util: {
            label: 'Утилиты',
            ...
            items: [
                ...
                { href: 'fill-all-budgets.html', title: 'Заполнить все бюджеты' },
                ...
                { href: 'reset-and-refill.html', title: 'Сброс и перезаполнение' },
                { href: 'clear-consolidated-data.html', title: 'Очистка данных' },
    ...
    function buildDropdown(section) {
        ...
        for (var i = 0; i < section.items.length; i++) {
            ...
            html += '<a href="' + item.href + '"' + cls + '>' + item.title + '</a>';
        }
        return html;
    }
    ...
    for (var sKey in SECTIONS) {
        ...
        navHTML += '' +
            '<div class="finka-nav-item' + activeClass + '">' +
            '  <button class="finka-nav-btn" data-section="' + sKey + '">' +
                 s.short + ' <span class="finka-arrow">\u25BE</span>' +
            '  </button>' +
    ...
    navHTML += '' +
        ...
        '        <span id="finkaStorageSize">' + getStorageSize() + ' МБ</span>' +
        '      </span>' +
    ...
    window.finkaToast = function (message, type) {
        ...
        toast.innerHTML = '<span class="finka-toast-icon">' + (TOAST_ICONS[type] || '') + '</span>' +
                          '<span>' + message + '</span>';
