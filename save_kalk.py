"""
Полный анализ калькуляции с сохранением в JSON
"""
...
for row_idx in range(1, min(51, ws.max_row + 1)):
    ...
    if row_data["cells"]:
        data["structure"].append(row_data)

# Сохраняем в файл
with open("kalk_structure.json", "w", encoding="utf-8") as f:
